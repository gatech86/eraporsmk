...
<head>
  <meta charset="utf-8">
    ...
    <title>Erapor SMK-PK - Registration </title>
                             ...
                             @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password_confirmation" id="password_confirmation" name="password_confirmation" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password">
                                    </div>
                                </div>
                                  <div class="row">
                                    <div class="col-12">
